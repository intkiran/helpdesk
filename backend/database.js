...
mongoose.connection.on("connected", function() {
  console.debug("Mongoose default connection connected to " + dbURI);
});

// When successfully reconnected
mongoose.connection.on("reconnected", function() {
  console.debug("Mongoose default connection reconnected!");
});

// If the connection throws an error
mongoose.connection.on("error", function(err) {
  console.debug("Mongoose default connection error: " + err);
...
mongoose.connection.on("close", function() {
  console.debug("Mongoose default connection closed");
});
